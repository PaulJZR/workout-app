...
function buildEMOM(eligible, params, timing) {
  ...
  const { totalSeconds: naturalSeconds, unknowns } = estimateRoundSeconds(rawMoves, params.effort);
    ...
    blocks: [
      {
        ...
        moves: toMoves(
          pickMainMoves(eligible, params.effort, ["push", "pull", "hinge", "squat", "carry"], params.durationMinutes),
          params.effort
        ),
      }
    ]
