...
function WorkoutOutput({ workout, effort, onShuffle, loading, onSave, saveState }) {
  return (
      ...
      <button
        ...
        className={`w-full py-3 rounded-2xl text-sm font-semibold transition-all duration-200 ${
          saveState === "idle"
            ...
            : saveState === "saving"
            ? "bg-warm-100 text-warm-400 border-2 border-warm-200 cursor-not-allowed"
            : saveState === "saved"
            ? "bg-teal-50 text-teal-600 border-2 border-teal-200 cursor-not-allowed"
            : "bg-red-50 text-red-600 border-2 border-red-200"
        }`}
      >
        {saveState === "idle" && "Save workout"}
      ...
      <header className="bg-white border-b border-warm-200 sticky top-0 z-10">
        <div className="max-w-lg mx-auto px-5 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-warm-400 mt-0.5">Your workout app</p>
          </div>
